// FXAA shader adapted from https://github.com/crashinvaders/gdx-vfx/blob/master/gdx-vfx/effects/assets/gdxvfx/shaders/fxaa.frag
// Original comment :
...
void main() {
	out_FragColor = fxaa(u_texture, v_texCoords, u_viewportInverse);
}
