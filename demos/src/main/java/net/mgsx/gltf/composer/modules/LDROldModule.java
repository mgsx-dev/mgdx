...
public class LDROldModule implements GLTFComposerModule
{
	@Override
	public void show(GLTFComposerContext ctx) {
		...
		ctx.colorShaderConfig.vertexShader = Gdx.files.classpath("shaders/gdx-pbr.vs.glsl").readString();
		ctx.colorShaderConfig.fragmentShader = Gdx.files.classpath("shaders/gdx-pbr.fs.glsl").readString();
