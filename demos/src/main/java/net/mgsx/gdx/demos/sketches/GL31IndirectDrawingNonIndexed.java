 ...
 * Also note that multi draw (glMultiDrawArraysIndirect) requires an extension to GLES 3.1
 * 
 * @author mgsx
 *
 */
public class GL31IndirectDrawingNonIndexed extends ScreenAdapter
{
	...
	public GL31IndirectDrawingNonIndexed() {
	...
	public void render(float delta) {
		...
		Gdx.gl.glBindBuffer(GL31.GL_DRAW_INDIRECT_BUFFER, drawCommands);
		Mgdx.gl31.glDrawArraysIndirect(GL20.GL_TRIANGLES, commandStride * commandIndex);
		mesh.unbind(shader);
	}
}
