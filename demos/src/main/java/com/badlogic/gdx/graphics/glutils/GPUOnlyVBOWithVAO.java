...
public class GPUOnlyVBOWithVAO implements VertexData {
	...
	public GPUOnlyVBOWithVAO (boolean isStatic, int numVertices, VertexAttribute... attributes) {
	...
	public GPUOnlyVBOWithVAO (boolean isStatic, int numVertices, VertexAttributes attributes) {
		...
		Gdx.gl.glBufferData(GL20.GL_ARRAY_BUFFER, numVertices * attributes.vertexSize, null, usage);
	...
	public FloatBuffer getBuffer () {
		throw new GdxRuntimeException("GPU only VBO doesn't have buffer");
	}
